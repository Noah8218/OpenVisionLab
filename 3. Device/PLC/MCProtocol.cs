    ...
    public class Mitsubishi
    {
        ...
        abstract public class McProtocolApp : Plc
        {
            ...
            public async Task<int> SetBitDevice(string iDeviceName, int iSize, int[] iData)
            {
                PlcDeviceType type;
                int addr;
                GetDeviceCode("D" + iDeviceName, out type, out addr);
                ...
                switch (CommandFrame)
                {
                        ...
                        data = new List<byte>(6)
                   {
                      ...
                      , 0x00
                        ...
                        break;
                    default:
                        CLOG.ABNORMAL( "Message frame not supported");
            ...
            private async Task<byte[]> TryExecution(byte[] iCommand, int minlength)
            {
                ...
                do
                {
                    ...
                    if (tCount < 0)
                    {
                        CLOG.ABNORMAL( "MC Protocol TryExecution Error");
                    }
            ...
            class McCommand
            {
                ...
                public int SetResponse(byte[] iResponse)
                {
                    ...
                    switch (FrameType)
                    {
                        ...
                        case McFrame.MC4E:
                            ...
                            break;
                        default:
                            CLOG.ABNORMAL( "Frame type not supported");
                ...
                public bool IsIncorrectResponse(byte[] iResponse, int minLenght)
                {
                    ...
                    switch (this.FrameType)
                    {
                        ...
                        default:
                            CLOG.ABNORMAL( "Type Not supported");
                ...
                lock(m_ob)
                {
                    ...
                    using (var ms = new MemoryStream())
                    {
                        ...
                        do
                        {
                            ...
                            if (sz == 0)
                            {
                                CLOG.ABNORMAL( "MC Protocol Execute Error");
                            }
                            ms.Write(buff, 0, sz);
