...
namespace KtemVisionSystem.Device
{
    public partial class DevLightController : Component
    {
        ...
        #region File Manager
        private string m_strPath = Application.StartupPath + "\\" + "LightControllerConfig" + ".xml";
        private string m_XMLName = "LightControllerConfig";
        public bool ReadInitFile()
        {
            try
            {
                //m_strPath = Application.StartupPath + "\\" + "Recipe\\" + iData.Recipe.Name + "\\" + "LightControllerConfig" + ".xml";
