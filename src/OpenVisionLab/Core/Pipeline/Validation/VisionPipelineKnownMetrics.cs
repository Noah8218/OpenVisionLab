...
namespace OpenVisionLab
{
    ...
    internal static class VisionPipelineKnownMetrics
    {
        ...
        private static readonly VisionPipelineMetricDefinition[] MetricDefinitions =
        {
            ...
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceCountMetric, DisplayName = "Instance Count", Description = "Stable row-major matching instances inspected by MultiMatchMean." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstancePassCountMetric, DisplayName = "Instance Pass Count", Description = "MultiMatchMean instances whose normalized relative ROI mean passed its range." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceFailCountMetric, DisplayName = "Instance Fail Count", Description = "MultiMatchMean instances rejected by pose, normalization, or mean gates." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceAggregatePassedMetric, DisplayName = "Instance Aggregate Passed", Description = "1 when the configured all-instances or minimum-pass aggregate contract passes; otherwise 0." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceMeanMinMetric, DisplayName = "Instance Mean Min", Description = "Minimum finite normalized relative-ROI mean across retained instances." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceMeanMaxMetric, DisplayName = "Instance Mean Max", Description = "Maximum finite normalized relative-ROI mean across retained instances." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceMeanAvgMetric, DisplayName = "Instance Mean Avg", Description = "Average finite normalized relative-ROI mean across retained instances." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceScoreMinMetric, DisplayName = "Instance Score Min", Description = "Minimum source matching score across retained fan-out instances." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceScoreMaxMetric, DisplayName = "Instance Score Max", Description = "Maximum source matching score across retained fan-out instances." },
            new VisionPipelineMetricDefinition { Name = VisionPipelineMultiMatchMeanService.InstanceValidPixelRatioMinMetric, DisplayName = "Instance Valid Pixel Ratio Min", Description = "Minimum normalized valid-pixel ratio across measured instances." },
        ...
        private static readonly Dictionary<string, string[]> ToolMetricNames = new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["multimatchmean"] = WithImageAndRectangleMetrics(ResultCount, VisionPipelineMultiMatchMeanService.InstanceCountMetric, VisionPipelineMultiMatchMeanService.InstancePassCountMetric, VisionPipelineMultiMatchMeanService.InstanceFailCountMetric, VisionPipelineMultiMatchMeanService.InstanceAggregatePassedMetric, VisionPipelineMultiMatchMeanService.InstanceMeanMinMetric, VisionPipelineMultiMatchMeanService.InstanceMeanMaxMetric, VisionPipelineMultiMatchMeanService.InstanceMeanAvgMetric, VisionPipelineMultiMatchMeanService.InstanceScoreMinMetric, VisionPipelineMultiMatchMeanService.InstanceScoreMaxMetric, VisionPipelineMultiMatchMeanService.InstanceValidPixelRatioMinMetric),
            ["multifixturemean"] = WithImageAndRectangleMetrics(ResultCount, VisionPipelineMultiMatchMeanService.InstanceCountMetric, VisionPipelineMultiMatchMeanService.InstancePassCountMetric, VisionPipelineMultiMatchMeanService.InstanceFailCountMetric, VisionPipelineMultiMatchMeanService.InstanceAggregatePassedMetric, VisionPipelineMultiMatchMeanService.InstanceMeanMinMetric, VisionPipelineMultiMatchMeanService.InstanceMeanMaxMetric, VisionPipelineMultiMatchMeanService.InstanceMeanAvgMetric, VisionPipelineMultiMatchMeanService.InstanceScoreMinMetric, VisionPipelineMultiMatchMeanService.InstanceScoreMaxMetric, VisionPipelineMultiMatchMeanService.InstanceValidPixelRatioMinMetric),
