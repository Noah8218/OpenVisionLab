...
{
    internal sealed class ShellLayerTestFacade
    {
        ...
        private readonly ShellLayerTestFacadeBindings bindings;

        public ShellLayerTestFacade(
            ...
            ShellLayerTestFacadeBindings bindings)
        {
    ...
    internal sealed class ShellLayerTestFacadeBindings
    {
