...
{
    internal sealed class ShellToolTestFacade
    {
        ...
        private readonly ShellToolTestFacadeBindings bindings;

        public ShellToolTestFacade(
            ...
            ShellToolTestFacadeBindings bindings)
        {
    ...
    internal sealed class ShellToolTestFacadeBindings
    {
