...
namespace OpenVisionLab
{
    internal sealed class OpenVisionShellHostSessionController
    {
        ...
        private readonly Action releaseDisplayManager;
            ...
            Action releaseDisplayManager)
        {
            ...
            this.releaseDisplayManager = releaseDisplayManager ?? throw new ArgumentNullException(nameof(releaseDisplayManager));
        }
        ...
        public bool DisposeSession()
        {
            ...
            dockedLayerWorkspace.ReleaseLayerViewerContents();
