...
- The nominal and Bright-NG inputs are project-authored public synthetic assets registered in the public sample manifest.
...
- Result images contain only the public synthetic brightness scenes and OpenVisionLab Arithmetic/Mean output.
...
- Latest-EXE validation/import passed with 2 Steps, 0 errors, 0 warnings, no dependencies, and no import-time image run.
- The public nominal sample passed at `MeanValueAvg=208` in 15.558 ms.
- The public Bright-NG sample produced the expected inspection NG at `MeanValueAvg=76.7 < 190` in 5.929 ms.
