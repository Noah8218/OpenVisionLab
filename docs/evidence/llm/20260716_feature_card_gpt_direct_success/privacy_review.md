...
- Result images contain only the public synthetic feature-card fixture and OpenVisionLab FeatureMatching output.
...
- Approval basis: explicit user continuation approval on 2026-07-16 KST
