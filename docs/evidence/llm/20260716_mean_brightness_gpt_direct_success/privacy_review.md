...
- The nominal and dark-negative inputs are project-authored public synthetic assets.
- The XML has one `Mean` Step and no external file or template dependency.
...
- Result images contain only the public synthetic Mean fixture and OpenVisionLab Mean overlay output.
