...
- `UI/Menu/Wpf/Recipe/PropertyGrid/VisionPipelineStepPropertyMapper.cs` now delegates only the three FeatureMatching aliases to `CreateFeatureMatchingProperty`.
- `UI/Menu/Wpf/Recipe/PropertyGrid/VisionPipelineStepPropertyMapper.FeatureMatching.cs` owns the adapter defaults, PropertyGrid model, step metadata, and acceptance metadata.
