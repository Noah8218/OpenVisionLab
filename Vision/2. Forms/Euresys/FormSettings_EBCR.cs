...
{
    public partial class FormSettings_EDataMatrix : MetroForm
    {
        ...
        public FormSettings_EDataMatrix(EImageBW8 image)
        {
            InitializeComponent();
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                EMatrixCodeReader eMatrixCodeReader = new EMatrixCodeReader();
                EMatrixCode eCode = eMatrixCodeReader.Read(ImageSource);
            }
            catch (Exception Desc)
            {
                //Logger.WriteLog(LOG.AbNormal, )
