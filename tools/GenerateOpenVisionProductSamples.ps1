...
function Save-ProductManifest {
    ...
    $rows = @(
        ...
        'docs/samples/public/product/field/Field_FilmStripe_SurfaceReview.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style stripe surface review sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_TexturedRoller_SurfaceReview.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style textured roller review sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_AluminumExtrusion_ProfileSection.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style aluminum profile section sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_PcbCorner_PadContamination.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style PCB corner contamination sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_CoatedWeb_SurfaceStain.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style coated web surface sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_MachinedShaft_SurfacePitting.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style machined shaft pitting sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_ProfileExtrusion_CrossSection.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style profile extrusion section sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_PcbPad_Contamination.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style PCB pad contamination sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_KeypadPanel_ButtonReview.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style keypad panel sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_ConnectorTerminal_Array.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style connector terminal array sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_KeypadOverlay_BacklightReview.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style keypad overlay sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_ControllerPanel_ButtonInspection.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style controller panel sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_TerminalStrip_FormInspection.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style terminal strip sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_PinHeader_ArrayInspection.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style pin header array sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_PcbAssembly_PadPattern.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style PCB assembly sample normalized to 960px max dimension',
        'docs/samples/public/product/field/Field_PerforatedPlate_HoleArray.png,Project-authored,OpenVisionLab,,Repository license,,Project-owned sample import 2026-07-03,Field-style perforated plate sample normalized to 960px max dimension'
    )
