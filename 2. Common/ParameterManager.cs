...
namespace OpenVisionLab._2._Common
{
    ...
    {
        public class SpecAreas : INotifyPropertyChanged
        {
            ...
            public SpecAreas DeepCopy()
            {
                SpecAreas temp = (SpecAreas)this.MemberwiseClone();
                return temp;
            }
        }

        public class ConnectorParameter : INotifyPropertyChanged
        {
            public event PropertyChangedEventHandler PropertyChanged;
            ...
            public ConnectorParameter DeepCopy()
            {
                ConnectorParameter temp = (ConnectorParameter)this.MemberwiseClone();
                return temp;
            }
        }

        public class SpecDistance : INotifyPropertyChanged
        {
            public event PropertyChangedEventHandler PropertyChanged;
            ...
            public SpecDistance DeepCopy()
            {
                SpecDistance temp = (SpecDistance)this.MemberwiseClone();
                return temp;
            }
        }
        ...
        public class SpecRectangle : INotifyPropertyChanged
        {
            ...
            public SpecRectangle() { }

            public SpecRectangle DeepCopy()
            {
                SpecRectangle temp = (SpecRectangle)this.MemberwiseClone();
                return temp;
            }

            public SpecRectangle(SpecRectangle C)
            {
                this.Roi = C.Roi;
