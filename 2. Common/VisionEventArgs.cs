...
namespace OpenVisionLab
{
    ...
    public class InspResultArgs : EventArgs
    {
        ...
        public List<BlobResult> black_Result = new List<BlobResult>();
        public List<BlobResult> white_Result = new List<BlobResult>();
        public List<BlobResult> totalResults = new List<BlobResult>();

        public List<BlobResult> pin_Results = new List<BlobResult>();
    ...
    public class VisionRectEventArgs : EventArgs
    {
        ...
        public VisionRectEventArgs(Rect rt)
        {
            m_rt = rt;
        }
    }
