...
namespace OpenVisionLab
{
    public sealed partial class OpenVisionLearnWindow : Window
    {
        ...
        {
            int topicIndex = NormalizeTopicIndex(topicList.SelectedIndex);
            txtTopicTitle.Text = ResolveTopicTitle(topicIndex);

            bool isPixelTopic = topicIndex == 0;
            bool isBrightnessTopic = topicIndex == 1;
            bool isThresholdTopic = topicIndex == 2;
            bool isFilterTopic = topicIndex == 3;
            bool isMorphologyTopic = topicIndex == 4;
            bool isBlobTopic = topicIndex == 5;
            bool isContourTopic = topicIndex == 6;
            bool isEdgeLineTopic = topicIndex == 7;
            bool isLineDistanceTopic = topicIndex == 8;
            bool isMatchingTopic = topicIndex == 9;
            bool isFeatureMatchingTopic = topicIndex == 10;
            bool isLayerRecipeTopic = topicIndex == 11;
            bool isEdgeBasedMatchingTopic = topicIndex == 12;
            bool isMetricsAcceptanceTopic = topicIndex == 13;
            bool isArithmeticTopic = topicIndex == 14;
            bool isGeometryTopic = topicIndex == 15;
            bool isColorHsvTopic = topicIndex == 16;
            ...
            txtTopicPractice.Text = ResolveSelectedTopicPracticeText(topicIndex);
            if (isPixelTopic)
            {
        ...
        private static string ResolveTopicTitle(int selectedTopicIndex)
        {
            return OpenVisionLearnTopicCatalog.ResolveTitle(selectedTopicIndex);
        }
