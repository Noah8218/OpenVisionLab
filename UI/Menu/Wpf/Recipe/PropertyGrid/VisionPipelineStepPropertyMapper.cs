    ...
    internal static partial class VisionPipelineStepPropertyMapper
    {
        ...
        public sealed class PipelineGeometryFeatureConverter : StringConverter
        {
            ...
            public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
            {
                ...
                string[] values = property.Context.GetCompatibleGeometryFeatureReferences(property.MeasurementMode, sourceA)
        ...
        {
            public PipelineGeometryMeasureProperty(VisionPipelineStep step, string name, VisionPipelinePropertyContext context) : base(step, name)
            {
